import{_ as e}from"./plugin-vue_export-helper-c27b6911.js";import{r as t,o as l,c as i,a as n,b as s,e as p,f as c}from"./app-c618f770.js";const u={},o=c(`<h2 id="注册组件基本步骤" tabindex="-1"><a class="header-anchor" href="#注册组件基本步骤" aria-hidden="true">#</a> 注册组件基本步骤</h2><ul><li>调用<code>Vue.extend()</code>方法创建组件构造器</li><li>调用<code>Vue.component()</code>方法注册组件</li><li>在Vue实例的作用范围内使用组件<code>&lt;my-cpn&gt;&lt;/my-cpn&gt;</code></li></ul><div class="language-vue line-numbers-mode" data-ext="vue"><pre class="language-vue"><code>  // Vue1.0
